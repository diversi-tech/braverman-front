...
import { LevelUrgencyStatus } from "../../enum/LevelUrgencyStatus.enum";
import { setAllEnums } from "../../Redux/Enums/enumsAction";
import './tasks.css';
...
export const Tasks = () => {
    ...
    const [levelUrgencyStatus, setLevelUrgencyStatus] = useState<LevelUrgencyStatus[]>([]);
    ...
    const levelState = useSelector((state: { LevelUrgencyStatus: { allEnums: { [key: string]: LevelUrgencyStatus[] } } }) => state.LevelUrgencyStatus);
