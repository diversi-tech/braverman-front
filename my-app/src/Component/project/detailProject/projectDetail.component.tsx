    ...
    <div className='project-details'>
      <div className='styleSection'>
        <div id="descrption" className='section'>
          <h2 className="inline-text" style={{ textAlign: 'center' }}>תאור הפרויקט</h2>
          <div>
            <p className="inline-text" >סוג הפרויקט: {project.status.value}</p>
          </div>
        </div>
        <div className='section' id="detail">
          <h2 className="inline-text">פרטי גישה</h2>
          <div>
        ...
        <div className='section' id="freeText">
          <h2>הערות</h2>
          {editing ? (
            <textarea
            ...
            <div className='textFree'>{project.freeText}</div>
          )}
        </div>
        {editing ? (
